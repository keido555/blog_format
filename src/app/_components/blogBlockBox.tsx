              ...
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div className="p-6 bg-white">
                  ...
                  <div className="flex items-center flex-wrap ">
                    <Link href="/blog/1" className="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0">
                      Learn More
                      <svg
            ...
            <div className="p-4 md:w-1/3 drop-shadow-xl">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div className="p-6 bg-white">
                  ...
                  <div className="flex items-center flex-wrap">
                    <Link href="/blog/2" className="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0">
                      Learn More
                      <svg
                        className="w-4 h-4 ml-2"
                        viewBox="0 0 24 24"
            ...
            <div className="p-4 md:w-1/3 drop-shadow-xl">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div className="p-6 bg-white">
                  ...
                  <div className="flex items-center flex-wrap ">
                    <Link href="/blog/3" className="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0">
                      Learn More
                      <svg
                        className="w-4 h-4 ml-2"
                        viewBox="0 0 24 24"
